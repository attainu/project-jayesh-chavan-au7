...
const Verify = function (props) {
    let profile = props.volunteerData.profile
    const [modalIsOpen, setModalIsOpen] = useState(false);
    const [otp, setOtp] = useState(new Array(6).fill(""));
    const [mob_no, setMobNo] = useState("");
    const [Time,setTime] = useState("10:00")
    const [register,setRegister] = useState(!!profile.mob_no)
    ...
    const codeverify = () => {
        ...
        window.confirmationResult
            ...
            .then(function (result) {
                ...
                httpRequest.post('/volunteer/update-user', { mob_no })
                .then(responce => {
        ...
        return(
            <div className="container">
                ...
                <div className="container d-flex justify-content-center w-50">
                    <div>
                        <h1 className="h1">{`+91-${profile.mob_no}`}</h1>
